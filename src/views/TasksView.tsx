...
import { CheckCircle2, Gift, Zap, Sparkles, Clock } from "lucide-react";
    ...
    <div className="space-y-8 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-slate-400 text-sm max-w-xl mt-1">
              Complete simple daily actions to earn cash rewards credited straight to your wallet.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {tasks.map((tsk) => (
          <div
            key={tsk.id}
            className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xl"
          >
            <div>
              <div className="flex items-center gap-3">
                <h3 className="text-lg font-bold text-white">{tsk.title}</h3>
            ...
            <div>
              {tsk.claimed ? (
                ...
                <button
                  ...
                  className="gold-gradient text-slate-950 font-black px-6 py-2.5 rounded-xl text-xs shadow-lg shadow-amber-500/20 hover:brightness-110 cursor-pointer"
                >
